...
public class SoulExplosion {
	...
	SoulExplosion(World par1World, Entity par2Entity, double par3, double par5, double par7, float par9) {
	...
	public void doExplosionA()
   {
	...
	public void doExplosionB(boolean par1) {
		...
		while (var2.hasNext()) {
			...
			/*
			 * if (var7 > 0) { Block.blocksList[var7].dropBlockAsItemWithChance(this.worldObj, var4, var5, var6, this.worldObj.getBlockMetadata(var4, var5, var6), 0.3F, 0);
			 * 
			 * if (this.worldObj.setBlockAndMetadataWithUpdate(var4, var5, var6, 0, 0, this.worldObj.isRemote)) { this.worldObj.notifyBlocksOfNeighborChange(var4, var5, var6, 0); }
			 * 
