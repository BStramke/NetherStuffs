...
public class WorldGenNetherStuffsMinable implements IWorldGenerator {
    ...
    public WorldGenNetherStuffsMinable(int id, int meta, int number)
    {
        this(id, number);
	...
	private void generateNether(World world, Random random, int i, int j) {
		for(int j1=0;j1<90;j1++){
            ...
            (new GenerateNetherStuffsMinable(minableBlockId,numberOfBlocks,minableBlockMeta)).generate(world, random, Xcoordinate, Ycoordinate, Zcoordinate);
    }
