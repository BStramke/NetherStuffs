...
public class SoulWorkBenchShapedRecipes implements IRecipe /* extends ShapedRecipes */{
	...
	public SoulWorkBenchShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack, int nSoulEnergyAmount) {
