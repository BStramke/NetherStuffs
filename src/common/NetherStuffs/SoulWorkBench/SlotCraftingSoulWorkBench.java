...
public class SlotCraftingSoulWorkBench extends SlotCrafting {
	...
	public SlotCraftingSoulWorkBench(EntityPlayer par1EntityPlayer,
	...
	public void onPickupFromSlot(EntityPlayer par1EntityPlayer,
		...
		if (((TileSoulWorkBench) this.craftMatrix)
				.consumeFuelFromTank(((TileSoulWorkBench) this.craftMatrix)
						.getStackInSlot(TileSoulWorkBench.nOutputSlot))) {

			GameRegistry.onItemCrafted(par1EntityPlayer, par2ItemStack,
					craftMatrix);
			...
			for (int var3 = 0; var3 < this.craftMatrix.getSizeInventory(); ++var3) {
				...
				if (var4 != null) {
					...
					if (var4.getItem().hasContainerItem()) {
						ItemStack var5 = var4.getItem().getContainerItemStack(
								var4);
