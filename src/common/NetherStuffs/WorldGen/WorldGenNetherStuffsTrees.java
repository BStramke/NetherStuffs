				...
				if (yCoord < 128 - nMaxHeight - 1 && var8 == Block.netherrack.blockID) {
					...
					for (var11 = 0; var11 < nMaxHeight; ++var11) {
						...
						if (var12 == 0 || block == null || block.isLeaves(par1World, xCoord, yCoord + var11, zCoord)) {
							...
							/*
							 * if (this.vinesGrow && var11 > 0) { if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(xcoord - 1, yCoord + var11, zCoord)) {
							 * this.setBlockAndMetadata(par1World, xcoord - 1, yCoord + var11, zCoord, Block.vine.blockID, 8); }
							 * 
							 * if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(xcoord + 1, yCoord + var11, zCoord)) { this.setBlockAndMetadata(par1World, xcoord + 1, yCoord + var11,
							 * zCoord, Block.vine.blockID, 2); }
							 * 
							 * if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(xcoord, yCoord + var11, zCoord - 1)) { this.setBlockAndMetadata(par1World, xcoord, yCoord + var11,
							 * zCoord - 1, Block.vine.blockID, 1); }
							 * 
							 * if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(xcoord, yCoord + var11, zCoord + 1)) { this.setBlockAndMetadata(par1World, xcoord, yCoord + var11,
							 * zCoord + 1, Block.vine.blockID, 4); } }
							 */
						}
					}
					 ...
					 * 
					 * if (par2Random.nextInt(5) == 0 && var6 > 5) { for (var11 = 0; var11 < 2; ++var11) { for (var12 = 0; var12 < 4; ++var12) { if (par2Random.nextInt(4 - var11) == 0)
					 * { var13 = par2Random.nextInt(3); this.setBlockAndMetadata(par1World, xcoord + Direction.offsetX[Direction.footInvisibleFaceRemap[var12]], yCoord + var6 - 5 +
					 * var11, zCoord + Direction.offsetZ[Direction.footInvisibleFaceRemap[var12]], Block.cocoaPlant.blockID, var13 << 2 | var12); } } } } }
					 */
