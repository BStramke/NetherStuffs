...
{	
	...
	{
        if(super.onItemUse(itemstack, entityplayer, world, x, y, z, par7, par8, par9, par10))
		{
        ...
        if(entityliving == null)
        {
    		...
    		loadSpawners(world);
	         try
	         {
	             ...
	             {
	            	 entityliving = (EntityLiving)class1.getConstructor(new Class[] {net.minecraft.src.World.class}).newInstance(new Object[] {
	            			 world});
	             }
	         }
	         catch(Throwable t)
