...
public class ContainerSoulSmelter{}/* extends Container {
	...
	public ContainerSoulSmelter(TileSoulCondenser tile_entity, InventoryPlayer player_inventory) {
		this.tile_entity = tile_entity;

		this.addSlotToContainer(new SlotSoulEnergyContainer(this.tile_entity, tile_entity.nTankDrainSlot, 59, 35));
		this.addSlotToContainer(new Slot(this.tile_entity, tile_entity.nTankFillSlot, 12, 9));
