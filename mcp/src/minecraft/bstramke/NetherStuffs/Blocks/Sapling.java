...
public class Sapling extends BlockSapling /* implements IPlantable */{
	...
	public Sapling(int par1) {
		super(par1);
		this.setStepSound(soundGrassFootstep);
		setUnlocalizedName("NetherSapling");
		setHardness(0.0F);
		for (int i = 0; i < SaplingItemBlock.getMetadataSize(); i++) {
			LanguageRegistry.instance().addStringLocalization("tile.NetherSapling." + SaplingItemBlock.blockNames[i] + ".name", SaplingItemBlock.blockDisplayNames[i]);
		}
	}
	...
	public int getMetadataSize() {
		return SaplingItemBlock.blockNames.length;
	}
