...
import bstramke.NetherStuffs.Blocks.soulEngine.TileEngine.EnergyStage;
...
public class RenderSoulEngine extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
		TileSoulEngine engine = ((TileSoulEngine) tileentity);
		if (engine != null) {
...
*/
	...
	private void render(EnergyStage energy, float progress, ForgeDirection orientation, ResourceLocation baseTexture, double x, double y, double z) {
		...
		if (NetherStuffsCore.render == NetherStuffsCore.RenderMode.NoDynamic) {
			return;
		}
