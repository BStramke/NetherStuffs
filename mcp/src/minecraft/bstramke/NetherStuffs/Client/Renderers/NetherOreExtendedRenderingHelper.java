...
public class NetherOreExtendedRenderingHelper implements ISimpleBlockRenderingHandler {
	private static int renderId;

	public static NetherOreExtendedRenderingHelper instance = new NetherOreExtendedRenderingHelper();

	public NetherOreExtendedRenderingHelper() {
	...
	public void renderInventoryBlock(Block par1Block, int metadata, int modelID, RenderBlocks renderer) {
		...
		OreExtended ore = (OreExtended) par1Block;
	...
	public boolean renderWorldBlock(IBlockAccess iBlockAccess, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
		...
		OreExtended ore = (OreExtended) block;
