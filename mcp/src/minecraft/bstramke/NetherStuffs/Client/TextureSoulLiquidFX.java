...
public class TextureSoulLiquidFX extends FMLTextureFX {
	...
	public TextureSoulLiquidFX() {
		this(110, 150, 40, 140, 150, 250, NetherItems.SoulEnergyLiquidItem.getIconFromDamage(0), NetherItems.SoulEnergyLiquidItem.getTextureFile());
	}

	public TextureSoulLiquidFX(int redMin, int redMax, int greenMin,
			int greenMax, int blueMin, int blueMax, int spriteIndex,
			String texture) {
		super(spriteIndex);
