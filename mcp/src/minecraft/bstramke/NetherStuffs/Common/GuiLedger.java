...
// / LEDGERS
public abstract class GuiLedger extends GuiContainer {
	protected TileEntity tile;
	
	public GuiLedger(Container container, IInventory inventory) {
		super(container);
	...
	protected class LedgerManager {
		...
		private GuiLedger gui;
		protected ArrayList<Ledger> ledgers = new ArrayList<Ledger>();

		public LedgerManager(GuiLedger gui) {
			this.gui = gui;
		}
